...
async function fetchAndDisplayUserPosts(userId, postListDiv) {
     ...
     try {
         ...
         posts.forEach(post => {
             ...
             postElement.classList.add('post', 'contest-entry'); // Added 'contest-entry'
             ...
             const postHeader = `
                 <div class="post-header">
                     ...
                     <div class="post-author-info">
                      ...
                      благоприятно Removed post-options div 
                 </div>
             `;
             ...
             // Removed postActions for profile page
             ...
             // Voting functionality for profile posts would need a new implementation if required.
         });
